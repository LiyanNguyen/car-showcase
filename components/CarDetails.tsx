									...
									<div className='flex-1 flex flex-col gap-3'>
										...
										<div className='flex gap-3'>
											<div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
												<Image className='object-contain' src={generateCarImageUrl(car, '29')} alt='car model' fill priority />
											</div>
											<div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
												<Image className='object-contain' src={generateCarImageUrl(car, '33')} alt='car model' fill priority />
											</div>
											<div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
												<Image className='object-contain' src={generateCarImageUrl(car, '13')} alt='car model' fill priority />
											</div>
										</div>
									</div>
